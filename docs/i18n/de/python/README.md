...
| `aether_media.metadata` | ID3- und MP4-Tag-Lesen/Schreiben (via Mutagen); NFO-XML-Scraping |
| `aether_media.playlist` | M3U- und XSPF-Playlist-Parsing und Serialisierung |
| `aether_media.plugins` | Plugin-Host — VLC-artige Extension-Skripte laden, aktivieren und aufrufen |
| `aether_media.cli` | Befehlszeilen-Einstiegspunkt (Befehl `aether-media`) |
