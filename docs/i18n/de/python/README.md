...
| `aethermedia.metadata` | ID3- und MP4-Tag-Lesen/Schreiben (via Mutagen); NFO-XML-Scraping |
| `aethermedia.playlist` | M3U- und XSPF-Playlist-Parsing und Serialisierung |
| `aethermedia.plugins` | Plugin-Host — VLC-artige Extension-Skripte laden, aktivieren und aufrufen |
| `aethermedia.cli` | Befehlszeilen-Einstiegspunkt (Befehl `aether-media`) |
