...
|--------|---------|--------|
| `media/` | `aether.media` | Celular / tablet (Jetpack Compose) |
| `media-tv/` | `aether.media.tv` | Android TV (lean-back, navegação por D-pad) |
...
| Profile | Identidade AetherTag e canal do criador |
...
// Participantes entram pelo AetherTag
