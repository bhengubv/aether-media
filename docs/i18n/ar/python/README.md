...
| `aether_media.metadata` | قراءة وكتابة وسوم ID3 وMP4 (عبر Mutagen)؛ استخراج XML من ملفات NFO |
| `aether_media.playlist` | تحليل وتسلسل قوائم التشغيل M3U وXSPF |
| `aether_media.plugins` | مضيف المكوّنات الإضافية — تحميل وتفعيل واستدعاء نصوص VLC-style |
| `aether_media.cli` | نقطة دخول سطر الأوامر (أمر `aether-media`) |
