...
|--------|---------|---------|
| `media/` | `aethernet.media` | Teléfono / tablet (Jetpack Compose) |
| `media-tv/` | `aethernet.media.tv` | Android TV (lean-back, navegación con D-pad) |
...
| Perfil | Identidad AetherNetTag y canal del creador |
