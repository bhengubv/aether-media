...
//
// How to run:
//   dotnet run --project samples/AetherNet.Media.RelayTest
//
// What it does:
...
// MediaContent is from AetherNet.Media.Core.  We serialise it to UTF-8 JSON and
...
/// Mirrors <c>AetherNet.Media.Core.Models.MediaContent</c> for serialisation
/// without taking a project dependency on AetherNet.Media.Core from this sample.
/// </summary>
