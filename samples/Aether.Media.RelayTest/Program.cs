...
//
// How to run:
//   dotnet run --project samples/Aether.Media.RelayTest
//
// What it does:
...
// MediaContent is from Aether.Media.Core.  We serialise it to UTF-8 JSON and
...
/// Mirrors <c>Aether.Media.Core.Models.MediaContent</c> for serialisation
/// without taking a project dependency on Aether.Media.Core from this sample.
/// </summary>
