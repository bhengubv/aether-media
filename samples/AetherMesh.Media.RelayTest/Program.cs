...
//
// How to run:
//   dotnet run --project samples/AetherMesh.Media.RelayTest
//
// What it does:
...
// MediaContent is from AetherMesh.Media.Core.  We serialise it to UTF-8 JSON and
...
/// Mirrors <c>AetherMesh.Media.Core.Models.MediaContent</c> for serialisation
/// without taking a project dependency on AetherMesh.Media.Core from this sample.
/// </summary>
