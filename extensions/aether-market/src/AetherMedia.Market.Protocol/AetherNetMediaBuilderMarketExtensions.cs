...
namespace AetherMedia.Market.Protocol;

/// <summary>
/// Extends <see cref="AetherNetMediaBuilder"/> with aether-market capability registration.
///
/// <para>
...
/// </code>
/// </summary>
public static class AetherNetMediaBuilderMarketExtensions
{
    /// <summary>
    ...
    ///
    /// <para>
    /// Node capability announced during handshake: <c>aethernet.market/v1</c>
    /// (see <see cref="AetherMedia.Market.Core.MarketCapabilityConstants.V1"/>).
    /// </para>
    ///
    ...
    /// <c>AddMarket()</c>.
    /// </exception>
    public static AetherNetMediaBuilder AddMarket(this AetherNetMediaBuilder builder)
    {
