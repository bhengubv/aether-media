...
/// <summary>
/// Extends <see cref="AetherMediaBuilder"/> with aether-market capability registration.
///
/// <para>
...
/// </code>
/// </summary>
public static class AetherMediaBuilderMarketExtensions
{
    /// <summary>
    ...
    ///
    /// <para>
    /// Node capability announced during handshake: <c>aether.market/v1</c>
    /// (see <see cref="Aether.Market.Core.MarketCapabilityConstants.V1"/>).
    /// </para>
    ///
    ...
    /// <c>AddMarket()</c>.
    /// </exception>
    public static AetherMediaBuilder AddMarket(this AetherMediaBuilder builder)
    {
