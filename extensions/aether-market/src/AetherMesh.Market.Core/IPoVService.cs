...
namespace AetherMesh.Market.Core;
...
public interface IPoVService
{
    ...
    /// <paramref name="subjectAetherMeshTag"/> and issues a signed
    /// <see cref="PoVToken"/> on successful proximity confirmation.
    /// </summary>
    /// <param name="subjectAetherMeshTag">The @tag of the device to witness.</param>
    /// <param name="ct">Cancellation token.</param>
    /// <returns>The newly issued <see cref="PoVToken"/>.</returns>
    Task<PoVToken> IssueTokenAsync(string subjectAetherMeshTag, CancellationToken ct = default);
