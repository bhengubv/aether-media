#ifndef AETHERMESH_VAULT_H
#define AETHERMESH_VAULT_H
...
/**
 * AetherMeshVaultManifest
 * Metadata for an erasure-coded, encrypted distributed backup.
 */
typedef struct AetherMeshVaultManifest {
 ...
 * Caller frees with aethermesh_vault_free_manifest().
 */
 ...
 * Returns a heap-allocated health struct; caller frees with aethermesh_vault_free_health().
 */
...
/**
 * Free a heap-allocated AetherMeshVaultManifest.
 */
void aethermesh_vault_free_manifest(AetherMeshVaultManifest *manifest);

/**
 * Free a heap-allocated AetherMeshVaultHealth.
 */
