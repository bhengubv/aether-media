...
/// <summary>
/// Extends <see cref="AetherMeshMediaBuilder"/> with aether-forge capability registration.
///
/// <para>Usage:</para>
/// <code>
...
/// </code>
/// </summary>
public static class AetherMeshMediaBuilderForgeExtensions
{
    /// <summary>
    ...
    ///
    /// <para>
    /// Node capability announced during handshake: <c>aethermesh.forge/v1</c>
    /// (see <see cref="ForgeCapabilityConstants.V1"/>).
    /// </para>
    /// </summary>
    public static AetherMeshMediaBuilder AddForge(this AetherMeshMediaBuilder builder)
    {
