...
namespace AetherMedia.Trust.Verification;

/// <summary>
/// Extends <see cref="AetherNetMediaBuilder"/> with aether-trust capability registration.
///
/// <para>Usage:</para>
/// <code>
...
/// </code>
/// </summary>
public static class AetherNetMediaBuilderTrustExtensions
{
    /// <summary>
    ...
    ///
    /// <para>
    /// Node capability announced during handshake: <c>aethernet.trust/v1</c>
    /// (see <see cref="TrustCapabilityConstants.V1"/>).
    /// </para>
    /// </summary>
    public static AetherNetMediaBuilder AddTrust(this AetherNetMediaBuilder builder)
    {
