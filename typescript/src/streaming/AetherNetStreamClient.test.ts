...
import { AetherNetStreamClient } from "./AetherNetStreamClient.js";
import type { AetherNetMediaPlayer } from "../player/AetherNetMediaPlayer.js";

// ── Mock AetherNetMediaPlayer ────────────────────────────────────────────────────
...
function makeMockPlayer() {
  ...
  const player = {
    ...
    segments,
  } as unknown as AetherNetMediaPlayer & { segments: typeof segments };
  return player;
}
...
describe("AetherNetStreamClient", () => {
  // ── Constructor ──────────────────────────────────────────────────────────
  ...
  describe("constructor", () => {
    ...
    it("activeStreamId is null before subscribing", () => {
      const client = new AetherNetStreamClient(makeMockPlayer());
  ...
  describe("subscribe — URI resolution", () => {
    it("resolves aether:// URI to the relay HTTP URL", async () => {
      ...
      assert.match(capturedUrl, /relay\.aethernet\.network/);
