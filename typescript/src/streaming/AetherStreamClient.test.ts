...
import { AetherStreamClient } from "./AetherStreamClient.js";
import type { AetherMediaPlayer } from "../player/AetherMediaPlayer.js";

// ── Mock AetherMediaPlayer ────────────────────────────────────────────────────
...
function makeMockPlayer() {
  ...
  const player = {
    ...
    segments,
  } as unknown as AetherMediaPlayer & { segments: typeof segments };
  return player;
}
...
describe("AetherStreamClient", () => {
  ...
  describe("constructor", () => {
    ...
    it("activeStreamId is null before subscribing", () => {
      const client = new AetherStreamClient(makeMockPlayer());
  ...
  describe("subscribe — URI resolution", () => {
    it("resolves aether:// URI to the relay HTTP URL", async () => {
      ...
      assert.match(capturedUrl, /relay\.aether\.network/);
