...
import { AetherMeshMediaPlayer } from "./AetherMeshMediaPlayer.js";
...
function makePlayer(video?: MockVideoElement) {
  ...
  const player = new AetherMeshMediaPlayer(v as unknown as HTMLVideoElement);
  return { player, video: v };
}

// ── Tests ──────────────────────────────────────────────────────────────────────

describe("AetherMeshMediaPlayer", () => {
  // ── Constructor ──────────────────────────────────────────────────────────

  describe("constructor", () => {
    it("throws when videoElement is null", () => {
      assert.throws(
        () => new AetherMeshMediaPlayer(null as unknown as HTMLVideoElement),
