/**
 * AetherNetMediaPlayer — wraps HLS.js for HLS/M3U8 streams and Shaka Player
...
export class AetherNetMediaPlayer {
  ...
  play(): void {
    this.video.play().catch((err) => {
      console.warn("[AetherNetMediaPlayer] play() rejected:", err);
      this._state = "error";
    });
  }
