...
import { AetherMediaPlayer } from "./AetherMediaPlayer.js";
...
function makePlayer(video?: MockVideoElement) {
  ...
  const player = new AetherMediaPlayer(v as unknown as HTMLVideoElement);
  return { player, video: v };
}

// ── Tests ──────────────────────────────────────────────────────────────────────

describe("AetherMediaPlayer", () => {
  // ── Constructor ──────────────────────────────────────────────────────────

  describe("constructor", () => {
    it("throws when videoElement is null", () => {
      assert.throws(
        () => new AetherMediaPlayer(null as unknown as HTMLVideoElement),
