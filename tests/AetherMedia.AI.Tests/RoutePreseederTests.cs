...
using AetherMedia.AI.Tests.Helpers;
...
public sealed class RoutePreseederTests
{
    ...
    /// Implements <see cref="IAetherNetAiProvider"/> directly (FakeAiProvider is sealed).
    /// </summary>
    private sealed class ThrowingForUhidAiProvider : IAetherNetAiProvider
    {
