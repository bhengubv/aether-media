...
/// Transport biases are fetched from <see cref="IAetherAiProvider.GetTransportBiasesAsync"/>
...
public sealed class AbrController : IAbrController
{
    ...
    /// <see cref="IAetherAiProvider.IsAvailable"/> is <c>false</c>,
    ...
    /// Used as the <c>payloadBytes</c> hint for <see cref="IAetherAiProvider.GetTransportBiasesAsync"/>.
    /// </summary>
