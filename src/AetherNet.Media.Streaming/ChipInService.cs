...
// ChipIn pools, contributions, and state are defined in AetherNet.Streaming.Models
...
namespace AetherNet.Media.Streaming;
...
/// <see cref="ChipInState"/>) come from <c>AetherNet.Streaming.Models</c>.
