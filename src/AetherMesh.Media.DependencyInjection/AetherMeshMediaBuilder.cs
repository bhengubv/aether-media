...
/// <summary>
/// Fluent builder returned by <see cref="ServiceCollectionExtensions.AddAetherMeshMedia"/>.
...
/// the builder.
/// </summary>
public sealed class AetherMeshMediaBuilder
{
    public IServiceCollection Services { get; }

    internal AetherMeshMediaBuilder(IServiceCollection services)
    {
    ...
    /// </summary>
    public AetherMeshMediaBuilder AddIdentity()
    {
    ...
    /// </summary>
    public AetherMeshMediaBuilder AddContent()
    {
    ...
    public AetherMeshMediaBuilder AddFootprintPolicy(Action<FootprintOptions>? configure = null)
    {
    ...
    /// </summary>
    public AetherMeshMediaBuilder AddSocial()
    {
    ...
    ///
    /// <para>
    /// When <see cref="AetherMesh.Extensibility.IAetherMeshAiProvider"/> is registered in the
    ...
    /// </para>
    /// </summary>
    public AetherMeshMediaBuilder AddStreaming()
    {
        ...
        Services.TryAddSingleton<IAbrController>(sp => new AbrController(
            sp.GetRequiredService<AetherMesh.Streaming.IStreamingService>(),
            ai: sp.GetService<AetherMesh.Extensibility.IAetherMeshAiProvider>()));
        return this;
    }
    ...
    /// <remarks>
    /// <para>
    /// <b>Prerequisite:</b> <see cref="AetherMesh.Extensibility.IAetherMeshAiProvider"/>
    ...
    /// <c>services.AddAetherMeshProtocol()</c>, which registers
    /// <c>NullAetherMeshAiProvider</c> as the fallback when no CircleAI SDK is
    ...
    /// no-op, so there is always exactly one <see cref="AetherMesh.Extensibility.IAetherMeshAiProvider"/>
    /// singleton in the container — shared by both the protocol layer and every
    /// Aether Media service registered here.
    /// </para>
    /// <para>
    /// If you call <c>AddAetherMeshMedia().AddAI()</c> on a bare
    /// <see cref="IServiceCollection"/> that has no
    /// <see cref="AetherMesh.Extensibility.IAetherMeshAiProvider"/> registration, an
    ...
    /// </para>
    /// </remarks>
    public AetherMeshMediaBuilder AddAI()
    {
        ...
        Services.TryAddSingleton<IContentRanker>(sp => new ContentRanker(
            ...
            sp.GetRequiredService<AetherMesh.Extensibility.IAetherMeshAiProvider>(),
    ...
    /// </summary>
    public AetherMeshMediaBuilder AddDistribution()
    {
    ...
    /// </summary>
    public AetherMeshMediaBuilder AddLocalLibrary()
    {
    ...
    /// </param>
    public AetherMeshMediaBuilder AddReel(string localUhid)
    {
