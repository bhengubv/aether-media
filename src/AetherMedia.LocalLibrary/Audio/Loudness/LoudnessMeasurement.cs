...
/// Tidal, and every broadcaster use.
/// </summary>
...
/// Maximum inter-sample peak after oversampling, in dBFS. Per ITU-R BS.1770
/// the true peak is the peak of the reconstructed analogue signal (typically
/// 1.5–2.5 dB above the digital sample peak for compressed material).
/// </param>
/// <param name="LoudnessRangeLu">
/// Statistical range between 10th and 95th percentile of short-term loudness
/// (in Loudness Units, LU). Wide dynamic-range material has high LRA; a
/// brick-wall master has very low LRA.
/// </param>
...
/// invalidation if the analyser implementation changes.
/// </param>
...
{
    /// <summary>
    /// Compute the linear gain factor required to normalise this content to
    /// the given target loudness, with optional headroom to avoid true-peak
    /// clipping.
    /// </summary>
