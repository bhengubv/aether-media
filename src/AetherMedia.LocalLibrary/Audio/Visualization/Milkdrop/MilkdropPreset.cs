...
/// <see cref="MilkdropParameters"/>. Equation lists preserve the order in
/// which they appear in the file — Milkdrop evaluates per_frame_1 before
/// per_frame_2, etc.
/// </summary>
public sealed record MilkdropPreset(
    ...
    IReadOnlyList<MilkdropCustomShape> Shapes,
    IReadOnlyList<MilkdropCustomWave> Waves,
    string? WarpShader = null,
    string? CompositeShader = null);
