...
/// as defined by ITU-R BS.1770-4 / EBU R128.
/// </summary>
public static class LoudnessTargets
{
    /// <summary>Spotify (web/mobile) Normal loudness target: −14 LUFS.</summary>
    ...
    /// <summary>Default target used by <see cref="IAudioNormalizer"/> when not specified: −14 LUFS (Spotify / YouTube / Tidal).</summary>
