...
/// <summary>
/// Default <see cref="ICrossfade"/> implementation using an equal-power
/// sin/cos S-curve. Equal-power preserves the perceived loudness of a
/// uniform-energy signal through the transition — the standard choice for
/// music players.
/// </summary>
public sealed class CrossfadeController : ICrossfade
{
        ...
        Span<float> gains)
    {
        ...
        for (var i = 0; i < sampleCount; i++)
        {
            ...
            // Equal-power S-curve: outgoing = cos(t·π/2), incoming = sin(t·π/2).
