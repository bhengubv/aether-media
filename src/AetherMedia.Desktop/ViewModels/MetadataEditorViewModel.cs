...
public sealed partial class MetadataEditorViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private string _genresText  = string.Empty;  // CSV input
    ...
    [ObservableProperty] private string _directorsText = string.Empty;  // newline-separated
    [ObservableProperty] private string _castText      = string.Empty;  // newline-separated
