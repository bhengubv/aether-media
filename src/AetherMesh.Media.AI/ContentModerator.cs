...
///   <item>
///     <description>
///       <b>AI assessment</b> via <see cref="IAetherMeshAiProvider.AssessThreatAsync"/>.
...
public sealed class ContentModerator : IContentModerator
{
    ...
    public ContentModerator(IAetherMeshAiProvider ai)
    {
    ...
    /// <see cref="IAetherMeshAiProvider.AssessThreatAsync"/>. Re-uses the existing
