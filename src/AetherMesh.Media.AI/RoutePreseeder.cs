...
/// <summary>
/// Uses <see cref="IAetherMeshAiProvider.SuggestRoutesAsync"/> to identify the
...
public sealed class RoutePreseeder : IRoutePreseeder
{
    ...
    /// <summary>
    /// Payload hint passed to <see cref="IAetherMeshAiProvider.SuggestRoutesAsync"/>
    ...
    public RoutePreseeder(IAetherMeshAiProvider ai, IRoutingService? routing = null)
    {
