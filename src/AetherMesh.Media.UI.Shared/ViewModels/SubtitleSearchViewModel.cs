...
/// <summary>Backs the subtitle search panel.</summary>
public sealed partial class SubtitleSearchViewModel : ViewModelBase
{
    ...
    public bool CanDownload => SelectedResult is not null && !IsDownloading;
    ...
    /// <summary>Opens the panel for <paramref name="videoFilePath"/> and kicks off a search.</summary>
