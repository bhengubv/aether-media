...
/// <summary>Wraps a <see cref="MediaReaction"/> for display in the player's live reaction feed.</summary>
public sealed class MediaReactionViewModel : ViewModelBase
{
    ...
    /// <summary>Returns an emoji representing the reaction type.</summary>
    ...
    /// <summary>Playback position formatted as "M:SS" or "H:MM:SS".</summary>
