...
/// <summary>Drives a creator's profile screen: content, live streams, follow state.</summary>
public sealed partial class ProfileViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private MediaProfileViewModel? _profile;
    [ObservableProperty] private ObservableCollection<MediaContentViewModel> _creatorContent = [];
    [ObservableProperty] private ObservableCollection<LiveStreamViewModel>   _creatorStreams  = [];
    ...
    /// <summary>Loads the profile identified by <paramref name="uhid"/>.</summary>
