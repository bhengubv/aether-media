...
namespace AetherMesh.Media.UI.Shared.ViewModels;

/// <summary>Drives the media player screen: playback controls, reactions, and watch-party state.</summary>
public sealed partial class PlayerViewModel : ViewModelBase
{
    ...
    [ObservableProperty] private ObservableCollection<MediaReactionViewModel> _liveReactions = [];
    [ObservableProperty] private bool _isInWatchParty;
    [ObservableProperty] private int  _watchPartyParticipants;
    ...
    // Event handlers — no Dispatcher needed; Blazor component marshals via InvokeAsync.
