...
// appsettings.json "AetherMedia:LocalUhid" or the AETHER_LOCAL_UHID env var.
var localUhid = builder.Configuration["AetherMedia:LocalUhid"]
             ?? Environment.GetEnvironmentVariable("AETHER_LOCAL_UHID")
             ?? "MEDIA-WEB01";
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(Aether.Media.UI.Shared.ViewModels.ViewModelBase).Assembly);
