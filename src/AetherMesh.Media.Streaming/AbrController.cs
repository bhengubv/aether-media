...
/// Transport biases are fetched from <see cref="IAetherMeshAiProvider.GetTransportBiasesAsync"/>
...
public sealed class AbrController : IAbrController
{
    ...
    private readonly IAetherMeshAiProvider?  _ai;
    ...
    /// <see cref="IAetherMeshAiProvider.IsAvailable"/> is <c>false</c>,
    ...
    /// Used as the <c>payloadBytes</c> hint for <see cref="IAetherMeshAiProvider.GetTransportBiasesAsync"/>.
    /// </summary>
