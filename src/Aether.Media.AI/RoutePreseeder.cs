...
/// <summary>
/// Uses <see cref="IAetherAiProvider.SuggestRoutesAsync"/> to identify the
...
public sealed class RoutePreseeder : IRoutePreseeder
{
    ...
    /// <summary>
    /// Payload hint passed to <see cref="IAetherAiProvider.SuggestRoutesAsync"/>
    ...
    public RoutePreseeder(IAetherAiProvider ai, IRoutingService? routing = null)
    {
