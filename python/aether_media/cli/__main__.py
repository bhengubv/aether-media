...
Usage:
  python -m aether_media.cli scan /path/to/music
  python -m aether_media.cli info /path/to/song.mp3
  python -m aether_media.cli playlist /path/to/playlist.m3u
"""
...
def cmd_playlist(file_path: str) -> int:
    ...
    if ext == ".xspf":
        from aether_media.playlist.xspf_parser import parse_xspf
