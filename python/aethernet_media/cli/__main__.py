...
Usage:
  python -m aethernet_media.cli scan /path/to/music
  python -m aethernet_media.cli info /path/to/song.mp3
  python -m aethernet_media.cli playlist /path/to/playlist.m3u
"""
...
def cmd_info(file_path: str) -> int:
    ...
    try:
        from aethernet_media.metadata.tag_reader import read_tags
...
def cmd_playlist(file_path: str) -> int:
    ...
    if ext == ".xspf":
        ...
        # Treat as M3U/M3U8
        from aethernet_media.playlist.m3u_parser import parse_m3u
