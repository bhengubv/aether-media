...
Usage:
  python -m aethermedia.cli scan /path/to/music
  python -m aethermedia.cli info /path/to/song.mp3
  python -m aethermedia.cli playlist /path/to/playlist.m3u
"""
...
def cmd_info(file_path: str) -> int:
    ...
    try:
        from aethermedia.metadata.tag_reader import read_tags
...
def cmd_playlist(file_path: str) -> int:
    ...
    if ext == ".xspf":
        from aethermedia.playlist.xspf_parser import parse_xspf
        ...
        # Treat as M3U/M3U8
        from aethermedia.playlist.m3u_parser import parse_m3u
